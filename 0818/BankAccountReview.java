...
public class BankAccountReview {
    public static void main(String[] args){
        ...
        account.deposit(500);
        System.out.println("提款:"+account.withdraw(300));
        System.out.println("提款5000:"+ account.withdraw(5000));
        System.out.println(account.getAccountId()+"餘額:"+account.getBalance());
    }
}
