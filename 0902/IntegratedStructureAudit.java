...
public class IntegratedStructureAudit {
    enum Requirement{ARRAYLIST,QUEUE,BST,HEAP
        ...
        static void audit(String scenario,String currentUsed,Requirement optimal){
            System.out.println(scenario);
            System.out.println(currentUsed);
            String bestPractice = choose(optimal);
        }
        public static void main(String[] args) {
            audit("上一頁功能","Stack",Requirement.LIFO);
            audit("尋找特定用戶", "ArrayList",Requirement.KEY_LOOPUP);
    }}
