...
public class SupportTicketQueue { 
    ...
    public static void main(String[] args){
        Comparator<Task> order = Comparator.comparingInt(Task::priority).thenComparingLong(Task::sequence).thenComparing(Task::id);
    ...
    while(!tasks.isEmpty()){
        ...
        System.out.println(task.id()+"|"+task.priority()+"|"+task.sequence());
    }
